      ...
      <div className="bg-primary rounded-lg p-4 h-1/2 w-2/3 sm:w-2/3 md:w-2/3 lg:w-1/3 xl:w-1/3">
        <div className="flex justify-between">
          ...
          <button
            onClick={onClose}
            type="button"
            class="inline-flex items-center justify-center w-8 h-8 rounded-full bg-orange-500 text-white hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 "
          >
            <svg
